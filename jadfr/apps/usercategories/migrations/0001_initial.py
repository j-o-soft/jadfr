...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table('usercategories_category', (
        ...
        db.send_create_signal('usercategories', ['Category'])


    def backwards(self, orm):
        # Deleting model 'Category'
        db.delete_table('usercategories_category')
